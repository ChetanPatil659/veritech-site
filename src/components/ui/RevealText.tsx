...
const TextContent: React.FC<TextContentProps> = ({ titleText, descriptionText }) => (
  <>
    <div className="w-full px-4 lg:w-1/3 h-1/4 lg:h-1/3 flex items-center lg:items-end justify-center lg:justify-start mb-2 lg:mb-0 p-6">
      <h1 className="font-julius text-xl md:text-4xl font-extrabold text-center lg:text-left">
        {titleText}
...
const RevealText: React.FC = () => {
  ...
  const contentProps = {
    titleText: "Transforming conversations into tomorrow's competitive edge with AI, today.",
    descriptionText: "Veritech is a new-age software development company that serves clients worldwide, offering support across different time zones including the US, Asia Pacific, EMEA, and MENA."
  };
